...
const prodConfigFile = require('./../environments/prod');
const constantsFile = require('./../../src/app/core/constants');

// stringify values again so definePlugin can parse correctly
helpers.stringifyObjValues(prodConfigFile);

// merge default and prod configs, with preference to prod configs
const CONFIG = webpackMerge(defaultConfigFile, prodConfigFile, constantsFile, {
