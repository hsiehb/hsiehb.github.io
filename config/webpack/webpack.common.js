...
const configFile = require('./../environments/default');
const METADATA = {
  title: configFile.CONFIG.title,
  baseUrl: '/',
...
helpers.stringifyObjValues(configFile);
helpers.stringifyObjValues(constantsFile);
  ...
  return {
    ...
    plugins: [
      ...
      new LoaderOptionsPlugin({
        debug: true,
        options: {
          sassResources: ['./src/app/core/styles/variables.scss', './src/app/core/styles/mixins.scss', './src/assets'],
