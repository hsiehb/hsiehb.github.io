...
const devConfigFile = isDevServer ? require('./../environments/local') : require('./../environments/dev');
...
module.exports = function (options) {
  return webpackMerge(commonConfig({env: ENV}), {
     ...
     * The server emits information bootstrap the compilation state to the client,
